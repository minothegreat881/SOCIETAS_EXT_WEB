    ...
    <div className="relative">
      ...
      >
        {cards.map((card, index) => (
          <div key={card.id} className="min-w-[33.333%] px-4 snap-center">
            <div className="flex flex-col rounded-lg overflow-hidden shadow-lg h-full">
              <div className="bg-red-900 p-6 flex flex-col items-center text-center flex-grow">
                ...
                <p className="text-white text-sm leading-relaxed line-clamp-4">{card.description}</p>
              </div>
              <Button
                variant="ghost"
